...
const ProfileDrawler: React.FC<ProfileDrawlerProps> = ({ isOpen, onClose, data }) => {
                                                        ...
                                                        <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                            ...
                                                            {!data.isGroup && (
                                                                <div>
                                                                    ...
                                                                    <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">{otherUsers.email}</dd>
                                                                </div>
                                                            )}
                                                            {!data.isGroup && (
                                                                <>
